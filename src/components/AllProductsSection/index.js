...
class AllProductsSection extends Component {
  ...
  onFilterByRating = activeRatingId => {
    this.setState({activeRatingId}, this.getProducts)
  }

  onFilterByCategory = activeCategoryId => {
  ...
  renderProductsList = () => {
    ...
    const isLengthZero = productsList.length === 0
  ...
  renderFilteredProducts = () => {
    ...
    switch (apiStatus) {
      ...
      case apiStatusConstants.failure:
        return this.renderFailureHandle()
      default:
        return null
    }
  }
    ...
    return (
      <div className="all-products-section">
        <FiltersGroup
          ...
          onFilterByRating={this.onFilterByRating}
